...
const recive = "https://github.com/aecioeu/arquivos/raw/main/recive-message.mp3"
const send = "https://github.com/aecioeu/arquivos/raw/main/send-message.mp3"
...
$(document).on('click', '.speed', async function(){ 
  ...
  wavesurfer[id].setPlaybackRate(speed)
})
